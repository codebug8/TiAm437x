...
myPath="/mnt/hgfs/J/"  #利用虚拟机"文件共享"U盘的路径
RED_COLOR='\E[1;31m'         #红
...
#	./ti_make_rawboot   0x40300000    am437x_hardware.bin  raw.bin
	./tiimage.out   0x40300000    MMCSD    am437x_hardware.bin   /mnt/hgfs/J/MLO  
#	rm   -f *.dis  *.bin  *.o  *_elf tiimage.out
	ls /mnt/hgfs/J/MLO -l && echo -e  "${GREEN_COLOR}======MLO OK!======${RES}" || echo -e  "${RED_COLOR}======MLO ERROR!======${RES}"
	sync
}
